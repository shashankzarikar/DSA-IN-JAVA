public class SizeOfLargestBSTinBT {
    ...
    public static Info largestBST(Node root) {
        ...
        boolean isBST = leftInfo.isBST && rightInfo.isBST && leftInfo.max < root.data && rightInfo.min > root.data;
    ...
    public static void main(String args[]){
        ...
        largestBST(root);
        System.out.println("size of largest BST in this BT is "+ maxBST);
